//
//	JBUpcomingItenariesData.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class JBUpcomingItenariesData : NSObject, NSCoding{
	...
	{
        request_date = dictionary["request_date"] as? String == nil ? "" : dictionary["request_date"] as? String
        request_time = dictionary["request_time"] as? String == nil ? "" : dictionary["request_time"] as? String
        flight_id = dictionary["flight_id"] as? String == nil ? "" : dictionary["flight_id"] as? String
		...
		requestId = dictionary["request_id"] as? String == nil ? "" : dictionary["request_id"] as? String
	...
	func toDictionary() -> NSDictionary
	{
		...
		if request_date != nil{
			dictionary["request_date"] = request_date
		}
        if request_time != nil{
            dictionary["request_time"] = request_time
        }
        if flight_id != nil{
            dictionary["flight_id"] = flight_id
        }
        if aircraftType != nil{
    ...
    */
	...
	{
        request_date = aDecoder.decodeObject(forKey: "request_date") as? String
        request_time = aDecoder.decodeObject(forKey: "request_time") as? String
        flight_id = aDecoder.decodeObject(forKey: "flight_id") as? String
    ...
    */
    public func encode(with aCoder: NSCoder) 
	{
        ...
        if request_date != nil{
            aCoder.encode(request_date, forKey: "request_date")
        }
        if request_time != nil{
            aCoder.encode(request_time, forKey: "request_time")
        }
        if flight_id != nil{
            aCoder.encode(flight_id, forKey: "flight_id")
        }
		if createdAt != nil{
